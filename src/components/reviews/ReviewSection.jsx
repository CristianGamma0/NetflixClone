...
import { useMyReview, useCreateReview, useUpdateReview, useDeleteReview } from '../../hooks/useReviews';
...
const ReviewSection = ({ profileId, tmdbId, mediaType, movieData }) => {
  ...
  const { data: myReview, isLoading } = useMyReview(profileId, tmdbId, mediaType);
